<%@ Page Title="Cart" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="HondaXpress.Cart" %>
        ...
        <div class="col-md-9">
                    ...
                    <div class="media" style="border: 1px solid #eaeaec;">
                        <div class="media-left">
                            <a href="ProductView.aspx?PID=<%#Eval("PID") %>" target="_blank">
                                <img width="100px" class="media-object" src="Images/Products/<%#Eval("PID") %>/<%#Eval("Name") %><%#Eval("PID") %><%#Eval("Extention") %>"" onerror="this.src='images/noimage.jpg'">
                            </a>
                        </div>
         ...
         <div class="col-md-3" runat="server" id="divPriceDetails">
            <div style="border-bottom: 1px solid #eaeaec;">
                ...
                <div>
                    <label hidden>Cart Total</label>
                    <span class="pull-right priceGray" id="spanCartTotal" runat="server" hidden></span>
                </div>
                <div>
                    <label hidden>Cart Discount</label>
                    <span class="pull-right priceGreen" id="spanDiscount" runat="server" hidden></span>
                </div>
            </div>
            <div>
